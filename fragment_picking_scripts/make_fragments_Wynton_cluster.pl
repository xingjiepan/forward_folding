...
$ENV{'SPARKSXDIR'} = '/wynton/home/kortemme/xingjiepan/Softwares/sparks-x';

# ROSETTA
# It's really bad that the path to Roland's rosetta is hard-coded in this file.  
# It would be better to get this path either from the command line or a 
...
my $FRAGMENT_PICKER = "/wynton/home/kortemme/xingjiepan/Softwares/Rosetta/Rosetta/main/source/bin/fragment_picker.linuxgccrelease";
...
my $ROSETTA_DATABASE = "/wynton/home/kortemme/xingjiepan/Softwares/Rosetta/Rosetta/main/database"; # rosetta database
#my $VALL = "$Bin/vall.jul19.2011"; # template database
my $VALL = "/wynton/home/kortemme/xingjiepan/Softwares/Rosetta/Rosetta/tools/fragment_tools/vall.jul19.2011.gz"; # template database

# BLAST path (Requires non-blast+ NCBI version)
#my $BLAST_DIR = "$Bin/../../../../src/blast";
#my $BLAST_DIR = "$Bin/../../../../src/blast";
my $BLAST_DIR = "/wynton/home/kortemme/xingjiepan/Softwares/blast/blast-2.2.26";
...
my $NR = "/wynton/home/kortemme/xingjiepan/Database/blast/nr/nr";

# spine-x/sparks (for phi, psi, and solvent accessibility predictions)
#my $SPARKS = "$Bin/../../../../src/sparks-x/bin/buildinp_query.sh";
my $SPARKS = "/wynton/home/kortemme/xingjiepan/Softwares/sparks-x/bin/buildinp_query.sh";

# PSIPRED (for secondary structure prediction)
my $PSIPRED_DIR = "/wynton/home/kortemme/xingjiepan/Softwares/local_protein_sequence_design/dependencies/dependencies/psipred";
...
my $PFILTNR = "/wynton/home/kortemme/xingjiepan/Database/blast/nr/nrfilt";

my $PDB_SEQRES      = "/wynton/home/kortemme/xingjiepan/Database/pdb/derived_data/pdb_seqres.txt";
...
my $PDB2VALL = "/wynton/home/kortemme/xingjiepan/Softwares/Rosetta/Rosetta/tools/fragment_tools/pdb2vall/pdb2vall.py --no_structure_profile";
